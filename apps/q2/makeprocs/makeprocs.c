...
void main (int argc, char *argv[])
{
  ...
  for(i=0; i<numprocs; i++) {
    process_create(PROD_OBJ_TO_RUN, h_mem_str, s_procs_completed_str, buf_lock_str, NULL);
    Printf("Producer %d created\n", i);
    process_create(CONS_OBJ_TO_RUN, h_mem_str, s_procs_completed_str, buf_lock_str, NULL);
